...
module Make (B : Potential.BACKEND) = struct
  ...
  and zero_copy_ftye_cf (Tye_fun (arg_rtye, res_rtye, arg_tye_rem)) =
    Tye_fun
      ( zero_copy_rtye_cf arg_rtye
      , zero_copy_rtye_cf res_rtye
      , zero_copy_tye_cf arg_tye_rem )
  ;;
  ...
  and zero_out_ftye_cf (Tye_fun (arg_rtye, res_rtye, arg_tye_rem)) =
    zero_out_rtye_cf arg_rtye;
    zero_out_rtye_cf res_rtye;
    zero_out_tye_cf arg_tye_rem
  ;;
